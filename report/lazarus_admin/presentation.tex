...
\usepackage[left=0.2in, right=0.2in, top=0.25in, bottom=0.25in]{geometry}
\usepackage{graphicx}
\usepackage{booktabs}
\usepackage{xcolor}
\usepackage{colortbl}
...
{\Huge \bfseries \color{accent} Athenee Lazarus Alpha AMC}\\[0.5em]
...
\begin{tcolorbox}[colback=white, colframe=primary, title=\textbf{\large Historical net monthly returns of the selected Hedge Fund basket}, fonttitle=\sffamily\bfseries\large, arc=6pt, boxrule=1pt, toptitle=6pt, bottomtitle=6pt, left=4pt, right=4pt, top=0pt, bottom=0pt, colbacktitle=primary, halign title=center]
...
\textbf{\textcolor{primary}{E-mail}} & \href{mailto:arthur.dhonneur@athenee-investment.com}{\textcolor{primary}{arthur.dhonneur@athenee-investment.com}} \\
