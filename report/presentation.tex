...
\toprule
 & \textbf{CAGR} & \textbf{Std} & \textbf{Proxy Sharpe} & \textbf{MDD} & \textbf{Calmar} & \textbf{Pos Months} & \textbf{Up Capture} & \textbf{Down Capture} & \textbf{Alpha} & \textbf{Beta (t-stat)} & \textbf{Corr SP500} & \textbf{N months}\\
\midrule
\textbf{6-Month Rebalanced} & 27.59\% & 4.40\% & 5.61 & -0.36\% & 76.81 & 96.2\% & 0.59 & -0.40 & 24.35\% & 0.03 (0.74) & 0.10 & 53 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
2022 & -0.3\% & 3.1\% & 4.6\% & 2.0\% & 3.9\% & 2.7\% & 2.8\% & 3.4\% & 1.9\% & 1.8\% & 2.2\% & 4.0\% & 37.3\% \\
2023 & 1.5\% & -0.4\% & 1.6\% & 1.7\% & 4.3\% & 3.5\% & 2.5\% & 0.3\% & 1.3\% & 0.1\% & 4.3\% & 2.3\% & 25.7\% \\
2024 & 1.5\% & 2.0\% & 3.8\% & 0.7\% & 0.7\% & 1.7\% & 3.7\% & 1.5\% & 2.0\% & 1.0\% & 2.3\% & 0.8\% & 23.9\% \\
2025 & 2.0\% & 2.1\% & 2.8\% & 2.4\% & 0.4\% & 0.5\% & 2.5\% & 1.7\% & 4.4\% & 3.7\% & 2.7\% & 1.1\% & 29.6\% \\
2026 & 2.3\% & 1.1\% & 1.2\% & 0.7\% & 0.4\% & - & - & - & - & - & - & - & 5.8\% \\
\bottomrule
\end{tabular}
}
\end{table}
