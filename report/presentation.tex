...
\textbf{Coban Clarion Multi Asset} & 36.55\% & 7.93\% & 4.02 & -4.90\% & 7.46 & 88.3\% & 0.61 & -0.88 & 32.83\% & -0.07 (-0.97) & -0.13 & 60 \\
\textbf{Coban Pod 1} & 32.78\% & 12.30\% & 2.39 & -5.05\% & 6.49 & 74.4\% & 0.76 & -0.29 & 25.96\% & 0.21 (2.68) & 0.29 & 82 \\
\textbf{Coban Orca} & 16.98\% & 12.81\% & 1.30 & -13.60\% & 1.25 & 72.2\% & 0.25 & -1.03 & 19.07\% & -0.11 (-0.63) & -0.11 & 36 \\
\textbf{Spear Digital} & 39.01\% & 22.49\% & 1.59 & -11.97\% & 3.26 & 64.2\% & 1.01 & -0.31 & 32.67\% & 0.24 (1.24) & 0.17 & 53 \\
\textbf{Blackrock Sta} & 14.75\% & 5.61\% & 2.50 & -3.24\% & 4.55 & 80.4\% & 0.25 & -0.43 & 14.75\% & -0.04 (-0.70) & -0.10 & 46 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\toprule
 & \textbf{CAGR} & \textbf{Std} & \textbf{Proxy Sharpe} & \textbf{MDD} & \textbf{Calmar} & \textbf{Pos Months} & \textbf{Up Capture} & \textbf{Down Capture} & \textbf{Alpha} & \textbf{Beta (t-stat)} & \textbf{Corr SP500} & \textbf{N months}\\
\midrule
\textbf{6-Month Rebalanced} & 28.50\% & 4.24\% & 6.00 & -0.06\% & 512.11 & 96.2\% & 0.60 & -0.43 & 25.09\% & 0.03 (0.70) & 0.10 & 53 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
2022 & -0.0\% & 2.8\% & 3.2\% & 1.8\% & 3.6\% & 2.7\% & 2.6\% & 2.5\% & 2.0\% & 2.7\% & 2.8\% & 4.7\% & 36.4\% \\
2023 & 1.1\% & 0.2\% & 1.0\% & 2.2\% & 4.6\% & 4.0\% & 2.8\% & 0.3\% & 1.5\% & 0.2\% & 3.5\% & 1.9\% & 25.9\% \\
2024 & 1.6\% & 0.6\% & 4.0\% & -0.1\% & 1.6\% & 2.2\% & 3.8\% & 1.6\% & 1.4\% & 1.9\% & 2.6\% & 1.5\% & 25.2\% \\
2025 & 2.6\% & 1.9\% & 2.7\% & 2.2\% & 1.0\% & 0.3\% & 2.8\% & 1.7\% & 3.6\% & 4.8\% & 3.1\% & 1.5\% & 32.1\% \\
2026 & 1.3\% & 1.7\% & 1.8\% & 1.3\% & 0.4\% & - & - & - & - & - & - & - & 6.7\% \\
\bottomrule
\end{tabular}
}
\end{table}
