...
\midrule
2022 & \cellcolor{posgreen!13!white}1.4\% & \cellcolor{posgreen!35!white}3.6\% & \cellcolor{posgreen!41!white}4.2\% & \cellcolor{posgreen!31!white}3.1\% & \cellcolor{posgreen!45!white}4.6\% & \cellcolor{posgreen!34!white}3.5\% & \cellcolor{posgreen!29!white}3.0\% & \cellcolor{posgreen!32!white}3.2\% & \cellcolor{posgreen!15!white}1.5\% & \cellcolor{posgreen!19!white}1.9\% & \cellcolor{posgreen!8!white}0.8\% & \cellcolor{posgreen!17!white}1.7\% & \cellcolor{posgreen!100!white}37.6\% \\
2023 & \cellcolor{posgreen!18!white}1.8\% & \cellcolor{posgreen!4!white}0.5\% & \cellcolor{posgreen!23!white}2.3\% & \cellcolor{posgreen!18!white}1.8\% & \cellcolor{posgreen!40!white}4.0\% & \cellcolor{posgreen!31!white}3.2\% & \cellcolor{posgreen!22!white}2.3\% & \cellcolor{posgreen!11!white}1.2\% & \cellcolor{posgreen!13!white}1.4\% & \cellcolor{posgreen!20!white}2.0\% & \cellcolor{posgreen!38!white}3.9\% & \cellcolor{posgreen!12!white}1.3\% & \cellcolor{posgreen!100!white}28.8\% \\
2024 & \cellcolor{posgreen!22!white}2.3\% & \cellcolor{posgreen!20!white}2.0\% & \cellcolor{posgreen!36!white}3.7\% & \cellcolor{posgreen!19!white}1.9\% & \cellcolor{posgreen!16!white}1.7\% & \cellcolor{posgreen!21!white}2.1\% & \cellcolor{posgreen!25!white}2.5\% & \cellcolor{posgreen!19!white}2.0\% & \cellcolor{posgreen!15!white}1.6\% & \cellcolor{posgreen!14!white}1.5\% & \cellcolor{posgreen!29!white}2.9\% & \cellcolor{posgreen!14!white}1.5\% & \cellcolor{posgreen!100!white}28.9\% \\
2025 & \cellcolor{posgreen!20!white}2.0\% & \cellcolor{posgreen!23!white}2.4\% & \cellcolor{posgreen!33!white}3.3\% & \cellcolor{posgreen!15!white}1.6\% & \cellcolor{posgreen!16!white}1.7\% & \cellcolor{posgreen!8!white}0.8\% & \cellcolor{posgreen!11!white}1.1\% & \cellcolor{posgreen!21!white}2.2\% & \cellcolor{posgreen!30!white}3.1\% & \cellcolor{posgreen!24!white}2.5\% & \cellcolor{posgreen!26!white}2.7\% & \cellcolor{posgreen!10!white}1.1\% & \cellcolor{posgreen!100!white}27.2\% \\
2026 & \cellcolor{posgreen!18!white}1.8\% & \cellcolor{posgreen!10!white}1.0\% & \cellcolor{posgreen!23!white}2.4\% & \cellcolor{posgreen!11!white}1.2\% & - & - & - & - & - & - & - & - & \cellcolor{posgreen!65!white}6.6\% \\
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
29.82\% & 3.31\% & 7.99 & 0.00\% & - & 100.0\% & 0.59 & -0.51 & 26.46\% (16.10) & -0.00 & -0.01 & 52 \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    ...
    \begin{minipage}[c]{0.15\linewidth}
        \centering
        \textbf{\Large \textcolor{accent}{7.7\%}}
    \end{minipage}
\end{tcolorbox}
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    ...
    \begin{minipage}[c]{0.15\linewidth}
        \centering
        \textbf{\Large \textcolor{accent}{15.4\%}}
    \end{minipage}
\end{tcolorbox}
...
\textbf{Quant HFT} & 27.24\% & 8.53\% & 2.89 & -1.74\% & 15.66 & 85.7\% & 0.56 & -0.86 & 25.46\% (4.01) & -0.04 & -0.05 & 28 \\
