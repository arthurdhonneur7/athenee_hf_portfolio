...
\toprule
 & \textbf{CAGR} & \textbf{Std} & \textbf{Proxy Sharpe} & \textbf{MDD} & \textbf{Calmar} & \textbf{Pos Months} & \textbf{Up Capture} & \textbf{Down Capture} & \textbf{Alpha} & \textbf{Beta (t-stat)} & \textbf{Corr SP500} & \textbf{N months}\\
\midrule
\textbf{6-Month Rebalanced} & 30.17\% & 3.81\% & 7.01 & 0.00\% & - & 100.0\% & 0.61 & -0.49 & 26.49\% & 0.02 (0.56) & 0.08 & 53 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
2022 & 0.7\% & 2.2\% & 3.4\% & 2.8\% & 3.7\% & 2.6\% & 2.4\% & 2.9\% & 2.1\% & 3.1\% & 3.4\% & 4.6\% & 39.6\% \\
2023 & 2.0\% & 1.4\% & 1.1\% & 2.1\% & 4.4\% & 3.5\% & 2.6\% & 0.9\% & 1.1\% & 1.0\% & 3.1\% & 1.9\% & 28.2\% \\
2024 & 2.1\% & 1.1\% & 3.9\% & 0.3\% & 2.1\% & 2.2\% & 3.6\% & 1.8\% & 1.0\% & 2.8\% & 2.8\% & 1.7\% & 28.6\% \\
2025 & 2.1\% & 2.3\% & 3.1\% & 1.3\% & 1.5\% & 0.4\% & 2.8\% & 1.7\% & 3.5\% & 4.4\% & 3.3\% & 0.9\% & 30.9\% \\
2026 & 0.7\% & 1.9\% & 1.3\% & 1.9\% & 0.4\% & - & - & - & - & - & - & - & 6.4\% \\
\bottomrule
\end{tabular}
}
\end{table}
