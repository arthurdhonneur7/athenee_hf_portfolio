...
\toprule
 & \textbf{CAGR} & \textbf{Std} & \textbf{Proxy Sharpe} & \textbf{MDD} & \textbf{Calmar} & \textbf{Pos Months} & \textbf{Up Capture} & \textbf{Down Capture} & \textbf{Alpha} & \textbf{Beta (t-stat)} & \textbf{Corr SP500} & \textbf{N months}\\
\midrule
\textbf{6-Month Rebalanced} & 28.52\% & 4.07\% & 6.25 & -0.65\% & 44.07 & 96.2\% & 0.61 & -0.41 & 24.97\% & 0.04 (1.04) & 0.14 & 53 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
2022 & 0.1\% & 3.3\% & 4.3\% & 2.0\% & 3.6\% & 3.1\% & 3.4\% & 3.1\% & 1.7\% & 2.0\% & 1.9\% & 3.4\% & 36.9\% \\
2023 & 1.8\% & -0.2\% & 2.1\% & 1.8\% & 4.1\% & 3.3\% & 2.9\% & 0.6\% & 1.4\% & 0.6\% & 4.1\% & 2.1\% & 27.5\% \\
2024 & 1.9\% & 2.2\% & 3.7\% & 1.2\% & 1.0\% & 1.8\% & 3.0\% & 1.8\% & 2.3\% & 1.0\% & 3.1\% & 0.3\% & 26.2\% \\
2025 & 1.8\% & 2.4\% & 1.4\% & 2.9\% & -0.6\% & 0.7\% & 2.8\% & 2.3\% & 3.6\% & 3.6\% & 2.8\% & 1.8\% & 28.6\% \\
2026 & 2.7\% & 1.2\% & 1.5\% & 0.8\% & 0.5\% & - & - & - & - & - & - & - & 6.9\% \\
\bottomrule
\end{tabular}
}
\end{table}
