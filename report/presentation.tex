...
\textbf{Enko} & 17.50\% & 10.61\% & 1.58 & -23.00\% & 0.76 & 79.1\% & 0.50 & -0.10 & 13.81\% & 0.19 (3.13) & 0.28 & 115 \\
...
\toprule
 & \textbf{CAGR} & \textbf{Std} & \textbf{Proxy Sharpe} & \textbf{MDD} & \textbf{Calmar} & \textbf{Pos Months} & \textbf{Up Capture} & \textbf{Down Capture} & \textbf{Alpha} & \textbf{Beta (t-stat)} & \textbf{Corr SP500} & \textbf{N months}\\
\midrule
\textbf{6-Month Rebalanced} & 29.01\% & 4.72\% & 5.48 & -0.64\% & 45.29 & 96.2\% & 0.64 & -0.39 & 24.86\% & 0.08 (1.94) & 0.26 & 53 \\
\bottomrule
\end{tabular}
}
\end{table}
...
\midrule
2022 & 0.4\% & 1.7\% & 2.6\% & 1.6\% & 3.5\% & 0.6\% & 2.7\% & 3.2\% & 1.3\% & 3.6\% & 4.1\% & 4.4\% & 34.1\% \\
2023 & 1.3\% & 0.3\% & -0.2\% & 1.1\% & 6.0\% & 4.2\% & 3.1\% & 0.8\% & 1.2\% & 1.1\% & 3.4\% & 1.9\% & 27.0\% \\
2024 & 1.9\% & 1.4\% & 3.9\% & -0.6\% & 1.9\% & 2.5\% & 3.2\% & 1.8\% & 0.6\% & 2.7\% & 2.7\% & 2.0\% & 26.5\% \\
2025 & 2.4\% & 2.2\% & 2.8\% & 1.0\% & 1.5\% & 0.7\% & 3.1\% & 2.0\% & 3.9\% & 4.9\% & 3.2\% & 1.8\% & 33.8\% \\
2026 & 1.2\% & 2.4\% & 0.7\% & 2.1\% & 0.4\% & - & - & - & - & - & - & - & 6.9\% \\
\bottomrule
\end{tabular}
}
\end{table}
