...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth, height=0.25\textheight, keepaspectratio]{combined_growth_worst20_sp500.pdf}
\end{figure}
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Quanstream}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{M1}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Crypto carry trade market neutral fund.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Vadantia}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Trading-oriented fund on FX and precious metals with more than 4 trades per day.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Wizard Quant}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Chinese equity market neutral fund that is strictly quant-driven.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{ARR}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{R Squared}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Equities futures arbitrage and dividend futures arbitrage relative value style fund.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Shiprock}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Fund investing in highly distressed debt and bond contracts.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Smithson}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
    \textcolor{primary}{Smithson fund description.}
\end{tcolorbox}

\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{26 Miles}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
...
\begin{tcolorbox}[colback=cardbg, colframe=cardborder, boxrule=0.5pt, arc=4pt, left=6pt, right=6pt, top=6pt, bottom=6pt]
    \textbf{\textcolor{primary}{Adar1}} \hfill \textbf{\textcolor{accent}{10.0\%}} \\[4pt]
