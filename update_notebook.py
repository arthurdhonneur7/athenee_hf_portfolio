...
\clearpage
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% PAGE 3: Portfolio Backtest Methodologies
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# Convert string into a list of lines with newline characters
new_source = [line + '\n' for line in NEW_CELL_CODE.split('\n')]
new_source[-1] = new_source[-1].rstrip('\n')

for cell in nb['cells']:
    if cell['cell_type'] == 'code' and 'import os\n' in cell['source'] and 'presentation.tex' in "".join(cell['source']):
